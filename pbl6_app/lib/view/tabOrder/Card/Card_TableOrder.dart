...
class CardTableOrder extends StatefulWidget {
  ...
  @override
  _CardTableOrderState createState() => _CardTableOrderState();
}

class _CardTableOrderState extends State<CardTableOrder> {
  @override
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              AppText(
                                text: "${widget.numberItemOrder} Items",
                              ),
                              ButtonWidget(
                                title: "Detail",
