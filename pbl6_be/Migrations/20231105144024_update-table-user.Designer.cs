...
namespace pbl6_be.Migrations
{
    ...
    [Migration("20231105144024_update-table-user")]
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 5, 21, 40, 23, 636, DateTimeKind.Unspecified).AddTicks(9063), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 5, 21, 40, 23, 636, DateTimeKind.Unspecified).AddTicks(9097), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 5, 21, 40, 23, 636, DateTimeKind.Unspecified).AddTicks(9150), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Staff",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 5, 21, 40, 23, 636, DateTimeKind.Unspecified).AddTicks(9151), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 5, 21, 40, 23, 636, DateTimeKind.Unspecified).AddTicks(9170), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "User",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 5, 21, 40, 23, 636, DateTimeKind.Unspecified).AddTicks(9171), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$KLUGpfmOKWkuw0g.0nG5ROjEWftnmiizxl6kcJJp7YRpetaYop4Fq",
                            PhoneNumber = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$yGPoSZcCNZIKqdooVO9ym.PZJDLmzK/T/D4W05pRbUNnU9fQ4Ei.O",
                            PhoneNumber = "123456",
                            RoleId = 2,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$P2EiB46bElDhBNeP4J4fg.IIZ3Vi5XfR8MNwd.vgOcrrJdsauX2sm",
                            PhoneNumber = "123456",
                            RoleId = 3,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        });
