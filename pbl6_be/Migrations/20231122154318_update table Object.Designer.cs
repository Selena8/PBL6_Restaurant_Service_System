...
namespace pbl6_be.Migrations
{
    ...
    [Migration("20231122154318_update table Object")]
    partial class updatetableObject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 22, 22, 43, 18, 97, DateTimeKind.Unspecified).AddTicks(3862), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 22, 22, 43, 18, 97, DateTimeKind.Unspecified).AddTicks(3897), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 22, 22, 43, 18, 97, DateTimeKind.Unspecified).AddTicks(3957), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Staff",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 22, 22, 43, 18, 97, DateTimeKind.Unspecified).AddTicks(3958), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 22, 22, 43, 18, 97, DateTimeKind.Unspecified).AddTicks(3977), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "User",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 22, 22, 43, 18, 97, DateTimeKind.Unspecified).AddTicks(3978), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$D5dYUAk3bQr6ZtS4uK3cJ.oR7fz2KkAdnSbb0rKLBS/hYVfnMWvWW",
                            PhoneNumber = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$g3RR.gHg1fP1oygHUIMnW.zpVt76UXe33ptUqeZZdHNKdUDRaCrTi",
                            PhoneNumber = "123456",
                            RoleId = 2,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$4D5putjYUn3bo5dadDtkEeml0RbDboJ4iCzBi0WA4A39Q/Np8gmVa",
                            PhoneNumber = "123456",
                            RoleId = 3,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        });
