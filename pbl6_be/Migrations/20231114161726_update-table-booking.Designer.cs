...
namespace pbl6_be.Migrations
{
    ...
    [Migration("20231114161726_update-table-booking")]
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 14, 23, 17, 25, 741, DateTimeKind.Unspecified).AddTicks(7162), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 14, 23, 17, 25, 741, DateTimeKind.Unspecified).AddTicks(7201), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 14, 23, 17, 25, 741, DateTimeKind.Unspecified).AddTicks(7271), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Staff",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 14, 23, 17, 25, 741, DateTimeKind.Unspecified).AddTicks(7272), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 14, 23, 17, 25, 741, DateTimeKind.Unspecified).AddTicks(7295), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "User",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 14, 23, 17, 25, 741, DateTimeKind.Unspecified).AddTicks(7296), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$o95bXP4PO.Sn4g98pZbZaOmPLr.lvxIfwHCSbuuVDbKf3Q4G9d6l.",
                            PhoneNumber = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$RSF/QOTtksXjCBcjg2sNferw3eFML6DTCMgUEjqFr3BB4LnABqlFC",
                            PhoneNumber = "123456",
                            RoleId = 2,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$YlrVctatLCrzt.5im5Xux.0twKZNplPIgpEjEHtEmj9C1lXK7RwWu",
                            PhoneNumber = "123456",
                            RoleId = 3,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        });
