...
namespace pbl6_be.Migrations
{
    ...
    [Migration("20231123050216_add table shift")]
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 12, 2, 15, 209, DateTimeKind.Unspecified).AddTicks(3640), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 12, 2, 15, 209, DateTimeKind.Unspecified).AddTicks(3683), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 12, 2, 15, 209, DateTimeKind.Unspecified).AddTicks(3758), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Staff",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 12, 2, 15, 209, DateTimeKind.Unspecified).AddTicks(3759), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 12, 2, 15, 209, DateTimeKind.Unspecified).AddTicks(3783), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "User",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 12, 2, 15, 209, DateTimeKind.Unspecified).AddTicks(3785), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$tADJ0higr02uoqkwHIqwXOspri9gCyY/n6qCfc9vNzdxRqfAHZJEm",
                            PhoneNumber = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$9G/UhUn5K6uZYASUR/5eN.ZrOK3LOWeRQGwXIDysGUqUhxoj.7LUe",
                            PhoneNumber = "123456",
                            RoleId = 2,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$iPkI2v0260gTIY.Jyu3Kfu70zDfayh11vR5FKhvImqq7xiWnOHWOu",
                            PhoneNumber = "123456",
                            RoleId = 3,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        });
