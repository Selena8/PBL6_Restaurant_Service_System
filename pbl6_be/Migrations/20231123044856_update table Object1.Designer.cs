...
namespace pbl6_be.Migrations
{
    ...
    [Migration("20231123044856_update table Object1")]
    partial class updatetableObject1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 11, 48, 54, 462, DateTimeKind.Unspecified).AddTicks(9270), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 11, 48, 54, 462, DateTimeKind.Unspecified).AddTicks(9310), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 11, 48, 54, 462, DateTimeKind.Unspecified).AddTicks(9382), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "Staff",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 11, 48, 54, 462, DateTimeKind.Unspecified).AddTicks(9384), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 11, 48, 54, 462, DateTimeKind.Unspecified).AddTicks(9408), new TimeSpan(0, 7, 0, 0, 0)),
                            Description = "",
                            IsDeleted = false,
                            Name = "User",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 11, 23, 11, 48, 54, 462, DateTimeKind.Unspecified).AddTicks(9409), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("pbl6_be.Domain.Models.Schemas.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$XSUVj7czHcAvl/3xo5HXCe2zWY3FK7Qs3YWD.mCttPe0lziXV4QDe",
                            PhoneNumber = "123456",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$OGhXw4A3MlbUSpGT3Lkgp.tLoCbOmgsRbLSZIxUKbPJS0CGqUKmba",
                            PhoneNumber = "123456",
                            RoleId = 2,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "",
                            Password = "$2a$11$wtTDReELVkQdmpRWxwO3cO9Jj0L9wx98GKS0.W83yc6DUzRzzTcNi",
                            PhoneNumber = "123456",
                            RoleId = 3,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0))
                        });
