  ...
  return (
    <Element name="booking" className="element">
        <ScrollAnimation animateIn="fadeInUp" animateOnce={true} delay={100}>
            <div className="container grid md:grid-cols-2 grid-cols-1 py-12 px-3 mx-auto">
                <div className="img-content">
                    <img className="w-full h-full max-h-[500px]" src="https://themewagon.github.io/restoran/img/about-1.jpg" alt="" />
                </div>
                <div className="form-content bg-[#0F172B] flex justify-center items-center">
                    <div className="form p-5 pb-[50px]">
