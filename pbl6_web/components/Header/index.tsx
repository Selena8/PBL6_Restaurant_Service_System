...
const Header = () => {
    ...
    return (
        ...
        <Navbar/>
        <div className="hero-header py-12 bg-center bg-no-repeat bg-cover bg-[#0F172B] mb-12" style={{backgroundImage: "linear-gradient(rgba(15, 23, 43, .9), rgba(15, 23, 43, .9)), url('/assets/images/bg-hero.jpg')"}}>
            <div className="hero-container lg:!grid grid-cols-2 flex flex-col lg:my-12 py-12 px-3 items-center justify-center mx-auto">
                <div className="mt-12 px-6 lg:w-[90%] text-center lg:text-left">
                    ...
                    <Button label="BOOK A TABLE" bgcolor="#FE724C" btnSize="lg" animation="animated slideInLeft" />
                </div>
                <div className="md:mt-8 sm:mt-8 flex justify-end">
                    <img src={Hero} alt="food-hero" className="animation-img w-[80%]"/>
                </div>
            </div>
        </div>
    </div>
