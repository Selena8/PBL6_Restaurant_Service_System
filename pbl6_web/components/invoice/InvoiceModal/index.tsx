    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <div className="min-h-screen px-4 text-center">
          ...
          >
            <div className="my-8 inline-block w-full max-w-lg transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-4 flex flex-col items-end space-y-2">
                    <div className="flex w-full justify-between border-t border-black/10 pt-2">
                      ...
                      <span>{formatNumber(invoiceInfo.total)} (VND)</span>
                    </div>
                  </div>
                </div>
              </div>
